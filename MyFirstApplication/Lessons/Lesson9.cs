...
internal class Lesson9
{
    ...
    /*
     Private access modifie can only be seen within the class, struct or nested type
     */
    ...
    /*
     Internal access modifier can be seen within the assembly, not other assemblies. 
     */
    ...
    /*
     Privavte Protected can be seen only within the class and child(derived) class
